...
/// 会员注册
/// </summary>
public partial class MemberPortal_UserRegister : System.Web.UI.Page
{
    #region  初始化页面
    ...
    protected void btnRegister_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                Response.Write("<SCRIPT language='javascript'>alert('注册成功！'); location.href='UserLogin.aspx'</SCRIPT>");
            }
            else
            {
